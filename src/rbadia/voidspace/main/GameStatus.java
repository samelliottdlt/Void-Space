...
public class GameStatus {
	...
	public synchronized boolean isNewEnemyShip1() {
		return newEnemyShip1;
	}

	public synchronized void setNewEnemyShip1(boolean newEnemyShip1) {
		this.newEnemyShip1 = newEnemyShip1;
	}
	
	public synchronized long setNewEnemyShipsDestroyed() {
		return enemyshipsDestroyed;
	}

	public synchronized void setNewEnemyShipsDestroyed(long enemyshipsDestroyed) {
